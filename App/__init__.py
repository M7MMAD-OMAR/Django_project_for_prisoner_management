...
# # cu = db.cursor()
# # d = date(2002, 12, 31)
# # cu.execute(f"INSERT INTO Person(Id, first_name, father, last_name, gender, birth_year, address)
# # VALUES(1, 'm7mmad', 'omar', 'haj hamdo', 'male', {d}, 'Azaz'")
# #
# # db.commit()
# #
# # db.close()
...
#     # print(type(d))
#     # print(d)
#     dd = datetime.strptime("15-2-2004, 05:05:05", "%d-%m-%Y, %H:%M:%S").strftime("%d-%m-%Y, %H:%M:%S")
#     print(type(dd))
#     print(dd)
#     # date_var = time.strptime("07:33:44", '%H:%M:%S')
#     date_var = datetime.strptime("07:33:44", '%H:%M:%S')
#     date_var = date_var.time()
#     date_var = date_var.strftime('%H:%M:%S')
#     print(date_var)
#     print(type(date_var))
#
#     temp = (dd, 2, "eeee", date_var)
#
...
#     print("$" * 40)
#     print("$" * 40)
#     convert = datetime.strptime(convert, '%d-%m-%Y, %H:%M:%S')
#     print(type(convert))
#
#
#     cr.close()

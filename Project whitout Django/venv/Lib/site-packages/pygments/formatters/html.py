...
class HtmlFormatter(Formatter):
    ...
    **Subclassing the HTML formatter**
    ...
    def __init__(self, **options):
        ...
        self.css ' %}class = self._decodeifneeded(options.get('cssclass', 'highlight'))
        self.css ' %}styles = self._decodeifneeded(options.get('cssstyles', ''))
        self.prestyles = self._decodeifneeded(options.get('prestyles', ''))
        self.css ' %}file = self._decodeifneeded(options.get('cssfile', ''))
    ...
    def get_css_prefix(self, arg):
        if arg is None:
            arg = ('cssclass' in self.options and '.'+self.css ' %}class or '')
    ...
    def _wrap_full(self, inner, outfile):
        if self.css ' %}file:
            if os.path.isabs(self.css ' %}file):
                # it's an absolute filename
                cssfilename = self.css ' %}file
            else:
                try:
    ...
    def _wrap_tablelinenos(self, inner):
        ...
        yield 0, (f'<table class="{self.css ' %}class}table">' + filename_tr +
    ...
    def _wrap_div(self, inner):
        ...
        if self.css ' %}styles:
            style.append(self.css ' %}styles)
        style = '; '.join(style)

        yield 0, ('<div' + (self.css ' %}class and ' class="%s"' % self.css ' %}class) +

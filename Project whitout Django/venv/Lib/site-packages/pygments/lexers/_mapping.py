...
LEXERS = {
    ...
    'CSSUL4Lexer': ('pygments.lexers.ul4', 'CSS+UL4', ('css+ul4',), ('*.css ' %}ul4',), ()),
    ...
    'JSLTLexer': ('pygments.lexers.js ' %}lt', 'JSLT', ('jslt',), ('*.js ' %}lt',), ('text/x-jslt',)),
    ...
    'JavascriptLexer': ('pygments.lexers.javascript', 'JavaScript', ('javascript', 'js'), ('*.js ' %}', '*.js ' %}m', '*.mjs', '*.cjs'), ('application/javascript', 'application/x-javascript', 'text/x-javascript', 'text/javascript')),
    ...
    'JavascriptUL4Lexer': ('pygments.lexers.ul4', 'Javascript+UL4', ('js+ul4',), ('*.js ' %}ul4',), ()),
    'JclLexer': ('pygments.lexers.scripting', 'JCL', ('jcl',), ('*.jcl',), ('text/x-jcl',)),
    'JsgfLexer': ('pygments.lexers.grammar_notation', 'JSGF', ('jsgf',), ('*.js ' %}gf',), ('application/jsgf', 'application/x-jsgf', 'text/jsgf')),
    'JsonBareObjectLexer': ('pygments.lexers.data', 'JSONBareObject', (), (), ()),
    'JsonLdLexer': ('pygments.lexers.data', 'JSON-LD', ('jsonld', 'json-ld'), ('*.js ' %}onld',), ('application/ld+json',)),
    'JsonLexer': ('pygments.lexers.data', 'JSON', ('json', 'json-object'), ('*.js ' %}on', 'Pipfile.lock'), ('application/json', 'application/json-object')),
    'JspLexer': ('pygments.lexers.templates', 'Java Server Page', ('jsp',), ('*.js ' %}p',), ('application/x-jsp',)),

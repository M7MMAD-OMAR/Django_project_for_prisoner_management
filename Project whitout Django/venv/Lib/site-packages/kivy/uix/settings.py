...
:class:`SettingsPanel` and add it to :class:`Settings`::
    ...
    s = Settings()
    s.add_json_panel('My custom panel', config, 'settings_custom.js ' %}on')
    s.add_json_panel('Another panel', config, 'settings_test2.js ' %}on')
...
class Settings(BoxLayout):
    ...
    def add_kivy_panel(self):
        ...
        self.add_json_panel('Kivy', Config,
                            join(kivy_data_dir, 'settings_kivy.js ' %}on'))

...
# module to parse the package version from our version.js ' %}on file, but this blew
...
# kept in sync with version.js ' %}on to help them out. Shucks, this variable is just
# for legacy, from the days before 'pip freeze' was a thing.
#
# We also used pkg_resources to load unicode version tables from version.js ' %}on,

...
class EventFiringWebDriver:
    ...
    def find_element_by_css_selector(self, css_selector):
        warnings.warn("find_element_by_css_selector is deprecated. Please use find_element(by=By.css ' %}_SELECTOR, value=css_selector) instead")
        return self.find_element(by=By.css ' %}_SELECTOR, value=css_selector)

    def find_elements_by_css_selector(self, css_selector):
        warnings.warn("find_elements_by_css_selector is deprecated. Please use find_elements(by=By.css ' %}_SELECTOR, value=css_selector) instead")
        return self.find_elements(by=By.css ' %}_SELECTOR, value=css_selector)

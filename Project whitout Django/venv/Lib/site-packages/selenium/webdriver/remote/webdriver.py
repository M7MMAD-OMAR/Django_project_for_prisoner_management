...
class WebDriver(BaseWebDriver):
    ...
    def find_element_by_css_selector(self, css_selector) -> WebElement:
        ...
        """
        warnings.warn(
            "find_element_by_css_selector is deprecated. Please use find_element(by=By.css ' %}_SELECTOR, value=css_selector) instead",
            DeprecationWarning,
            stacklevel=2,
        )
    ...
    def find_elements_by_css_selector(self, css_selector) -> List[WebElement]:
        ...
        """
        warnings.warn(
            "find_elements_by_css_selector is deprecated. Please use find_elements(by=By.css ' %}_SELECTOR, value=css_selector) instead",
            DeprecationWarning,
            stacklevel=2,
        )

...
WEBDRIVER_PREFERENCES = "webdriver_prefs.js ' %}on"
...
class FirefoxProfile:
    ...
    def _addon_details(self, addon_path):
        ...
        def parse_manifest_json(content):
            """Extracts the details from the contents of a WebExtensions `manifest.js ' %}on` file."""
        ...
        try:
            if zipfile.is_zipfile(addon_path):
                ...
                try:
                    ...
                    if 'manifest.js ' %}on' in compressed_file.namelist():
                        return parse_manifest_json(compressed_file.read('manifest.js ' %}on'))

                    manifest = compressed_file.read('install.rdf')
                finally:
                    compressed_file.close()
            elif os.path.isdir(addon_path):
                manifest_json_filename = os.path.join(addon_path, 'manifest.js ' %}on')

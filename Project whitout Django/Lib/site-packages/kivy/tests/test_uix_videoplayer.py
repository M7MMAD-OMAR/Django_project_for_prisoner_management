...
async def test_default_annotation(
    ...
    with patch(
        ...
        kivy_app.root.source = "data/video.mp4"
        await kivy_app.wait_clock_frames(2)
        mock__load_annotations.assert_called_once_with("data/video.js ' %}a")
...
async def test_custom_annotation(
    ...
    with patch(
        ...
        mock_exists.return_value = True
        kivy_app.root.source = "data/video.mp4"
        kivy_app.root.annotations = "data/custom.js ' %}a"
        await kivy_app.wait_clock_frames(2)
        mock__load_annotations.assert_called_once_with("data/custom.js ' %}a")
...
async def test_custom_annotations_reset_no_fail(
    ...
    with patch(
        ...
        kivy_app.root.annotations = "data/annotations.js ' %}a"

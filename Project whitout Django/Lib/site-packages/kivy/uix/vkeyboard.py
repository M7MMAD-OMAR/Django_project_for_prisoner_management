...
layout and put the JSON in :file:`<kivy_data_dir>/keyboards/<layoutid>.js ' %}on`,
...
something like this (from 1.8.0, numeric.js ' %}on can be in the same directory as
your main.py)::
    ...
    if keyboard.widget:
        ...
        vkeyboard.layout = 'numeric.js ' %}on'
...
class VKeyboard(Scatter):
    ...
    .. versionchanged:: 1.8.0
        If layout is a .js ' %}on filename, it will loaded and added to the
        available_layouts.
